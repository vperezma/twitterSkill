...
4. Give your function a name and description. For the initial code, just type `{}` which is valid Javascript that does nothing. We will be uploading our code via `grunt` later.
